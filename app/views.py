...
#     outputforReport['forecast_lower'] = outputforReport['forecast_lower'].astype(float)
    print("Line number 1824")
#     outputforReport['forecast_upper'] = outputforReport['forecast_upper'].astype(float)
    print("Line number 1826")
#     outputforReport['forecast_lower'] = outputforReport['forecast_lower'].fillna(0)
#     outputforReport['forecast_upper'] = outputforReport['forecast_upper'].fillna(0)
    print("replace check")
...
#     outputforReport['forecast_lower'] = outputforReport['forecast_lower'].replace(0,None)
    outputforReport = outputforReport.replace(np.NaN,None,inplace=True)
    ...
    print(" Anshuman data Pridiction Model Done : 1835")
    # print(" Anshuman data Data Manupulation Model Started : 1753")

    print(" Anshuman data Data Manupulation Model Done : 1838")

    print(" Anshuman data Report Creation Started : 1840")
