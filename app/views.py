...
class LoginAPI(APIView):
    ...
    def post(self, request):
        ...
        if Insertedpassword == password:
            ...
            if len(record2) != 0:
                return Response(
                    {"username": username, "unique_id": record2[0],
                     "BIiframe": record2[1], "group_id": record2[2],
                     "report_id": record2[3], "dataset_id": record2[4],
                     "MLiframe_web": record2[5],
                     "accesstoken": accessToken['token'], "embeded_url_web_BI": record2[6],
                     "groupIdML": record2[7],
                     "reportIdMLMobile": record2[8],
                     "datasetIdML": record2[9],
                     "embeddedUrlMobileML": record2[10],
                     "ReportIdWebML": record2[11],
